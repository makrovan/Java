...
//сперва хотел этот же класс использовать в классе Main для разбора Json-файла, чтобы не было дублирование кода,
//но задача же стоит только в написании тестов, поэтому остальной код трогать не стал
